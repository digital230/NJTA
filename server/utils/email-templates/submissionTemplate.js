const submissionTemplate = (name, verifyLink) => {
    return `<!DOCTYPE html
                    ...
                    <div style="padding: 40px 20px;">
                        ...
                        <h1 style="margin-bottom: 20px; font-stretch: normal; font-size: 13px; line-height: normal;
                            font-family: Times; color: #1c1e21; "><span style="font-size: 24pt; font-family: arial,
                                helvetica, sans-serif; color: #244687; ">Cultural Access Network Project</span></h1>
                        ...
                        <p style="margin-bottom: 20px; font-stretch: normal; font-size: 13px; line-height: normal;
                            font-family: Times; color: #1c1e21; "><span style="font-family: arial, helvetica,
                                sans-serif; font-size: 12pt; ">Below is a link to download your submission as a PDF file.</span></p>
                                <a style = "font-size: 13px; font-weight: bold; " target = "_blank" style="margin-bottom: 20px;" href=${verifyLink}>
                                Download</a>
...
module.exports = { submissionTemplate };
